  ...
  return <KeyboardAvoidingView style={s.root} behavior={Platform.OS==='ios'?'padding':undefined}>
    ...
    <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={s.content}>
      ...
      <Pressable onPress={onOpenCare} style={s.careCard}>
        <View style={s.careIcon}><Ionicons name="book-outline" size={23} color={c.white}/></View>
        <View style={{flex:1}}><Typography style={s.careTitle}>Polka Care</Typography><Typography style={s.careText}>Baza wiedzy o cyklu, objawach i samopoczuciu.</Typography></View>
