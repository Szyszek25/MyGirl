...
const starterMeetings=[
  {id:'m1',title:'Matcha + spacer po centrum',city:'Warszawa',when:'2026-09-27T17:30:00',place:'Śródmieście',description:'Najpierw matcha, potem luźny spacer po centrum. Bez spiny — poznajemy się na żywo.',spots:6,joined:4,host:'Maja',photo:'https://images.unsplash.com/photo-1511988617509-a57c8a288659?w=1200&q=82'},
  {id:'m2',title:'Girls night + karaoke',city:'Warszawa',when:'2026-09-28T20:00:00',place:'Centrum',description:'Karaoke, drinki i luźny wieczór. Możesz przyjść sama — większość osób się nie zna.',spots:8,joined:5,host:'Natalia',photo:'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1200&q=82'},
  {id:'m5',title:'Pilates + brunch',city:'Warszawa',when:'2026-10-03T11:00:00',place:'Mokotów',description:'Krótki pilates, potem brunch i kawa. Mała grupa, spokojny klimat.',spots:6,joined:3,host:'Klara',photo:'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=1200&q=82'},
  {id:'m6',title:'Vintage shopping + kawa',city:'Warszawa',when:'2026-10-04T13:00:00',place:'Praga',description:'Obchodzimy second handy, a potem siadamy na kawę i pokazujemy łupy.',spots:7,joined:4,host:'Daria',photo:'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=1200&q=82'},
  {id:'m7',title:'Kazimierz coffee walk',city:'Kraków',when:'2026-09-29T17:30:00',place:'Kazimierz',description:'Kawa i spacer po Kazimierzu. Dobre na pierwsze spotkanie bez wielkiego planowania.',spots:5,joined:3,host:'Ola',photo:'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=1200&q=82'},
  {id:'m8',title:'Foto spacer nad Wisłą',city:'Kraków',when:'2026-10-03T16:00:00',place:'Bulwary Wiślane',description:'Bierz telefon albo aparat. Robimy zdjęcia i poznajemy się przy okazji.',spots:6,joined:4,host:'Sonia',photo:'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=1200&q=82'},
  {id:'m3',title:'Pilates + brunch',city:'Wrocław',when:'2026-10-03T11:00:00',place:'Stare Miasto',description:'Pilates rano, potem brunch. Mała grupa i spokojny klimat.',spots:5,joined:3,host:'Julia',photo:'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=1200&q=82'},
  {id:'m9',title:'Wine bar girls night',city:'Wrocław',when:'2026-10-02T20:00:00',place:'Rynek',description:'Luźne wyjście na wino i rozmowy. Bez presji, bez zamkniętej ekipy.',spots:7,joined:5,host:'Nela',photo:'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=1200&q=82'},
  {id:'m10',title:'Brunch + vintage tour',city:'Poznań',when:'2026-10-04T12:00:00',place:'Jeżyce',description:'Brunch, potem kilka vintage shopów na Jeżycach.',spots:6,joined:4,host:'Kasia',photo:'https://images.unsplash.com/photo-1559339352-11d035aa65de?w=1200&q=82'},
  {id:'m4',title:'Book club + kawa',city:'Gdańsk',when:'2026-10-04T16:00:00',place:'Wrzeszcz',description:'Kawa i rozmowa o książce miesiąca. Nie musisz znać nikogo wcześniej.',spots:10,joined:7,host:'Sara',photo:'https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=1200&q=82'},
  {id:'m11',title:'Plaża + kawa na wynos',city:'Gdańsk',when:'2026-10-03T14:00:00',place:'Brzeźno',description:'Kawa na wynos i spacer plażą. Prosty plan na poznanie kilku osób.',spots:8,joined:5,host:'Natalia',photo:'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&q=82'},
  {id:'m12',title:'OFF Piotrkowska + koncert',city:'Łódź',when:'2026-10-02T19:00:00',place:'OFF Piotrkowska',description:'Najpierw coś zjemy, potem koncert i zobaczymy co dalej.',spots:7,joined:4,host:'Wiktoria',photo:'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=1200&q=82'},
  {id:'m13',title:'Kawa + spacer po Nikiszowcu',city:'Katowice',when:'2026-10-03T15:00:00',place:'Nikiszowiec',description:'Kawa, spacer i spokojne poznanie nowych osób.',spots:6,joined:3,host:'Dominika',photo:'https://images.unsplash.com/photo-1445116572660-236099ec97a0?w=1200&q=82'}
];
      ...
      {!!selected&&<View style={s.detailRoot}>
        ...
        <ScrollView contentContainerStyle={s.detailScroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={s.section}>
            ...
            <View style={s.peopleRow}>{people.slice(0,4).map(p=><Image key={p.id} source={{uri:p.photo}} style={s.detailAvatar}/>)}</View>
          </View>
