...
export default function SettingsScreen({onClose,onSafety,onPartner,onReset,onPasswordReset,onFeaturePreferencesChange}){
  ...
  return <ScrollView contentContainerStyle={s.page}>
    ...
    <View style={s.group}>
      ...
      <Row icon="people-outline" title="Astro matching w Poznaj" subtitle="Zabawne dopasowanie znaków na profilach" right={<Switch value={features.zodiacPeopleMatching} onValueChange={value=>setFeature('zodiacPeopleMatching',value)} trackColor={{false:'#D9D4D7',true:'#F7A7C0'}} thumbColor={features.zodiacPeopleMatching?c.pink:'#fff'}/>}/>
