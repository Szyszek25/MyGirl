            ...
            <Surface>
              ...
              <View style={s.galleryGrid}>
                {(draft.galleryPhotos||[]).map((item,index)=><View key={item.path||item.url||index} style={s.galleryEditItem}>
                  <Image source={{uri:item.url||item}} style={s.galleryThumb}/>
