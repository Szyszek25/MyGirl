...
export default function NativeProfile({account,showCare=true,onSafety,onPartner,onSettings,onCycle,onCare,onSave}){
  ...
  return <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS==='ios'?'padding':undefined}>
    <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={s.page}>
      <View style={s.profileTop}><View style={{flex:1}}><PageHeading kicker="MOJA PRZESTRZEŃ" title="Twój profil."/></View><Pressable accessibilityRole="button" accessibilityLabel="Ustawienia" onPress={onSettings} style={s.settingsButton}><Ionicons name="settings-outline" size={23} color={c.ink}/></Pressable></View>
