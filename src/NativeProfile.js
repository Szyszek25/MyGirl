  ...
  return <KeyboardAvoidingView style={{flex:1}} behavior={Platform.OS==='ios'?'padding':undefined}>
    <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={s.page}>
      ...
      <>
        ...
        <View style={s.actionTiles}>{showCare&&<Pressable onPress={onCycle} style={s.actionTile}><View style={s.actionTileIconSoft}><Ionicons name="calendar-outline" size={22} color={c.pink}/></View><Typography style={s.actionTileText}>Cykl</Typography><Typography style={s.actionTileSub}>Kalendarz i objawy</Typography></Pressable>}
