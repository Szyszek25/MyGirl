    ...
    <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={s.page}>
      ...
      <>
        ...
        <View style={s.infoTiles}>
          {!!account.goal&&<View style={s.infoTile}><View style={s.infoTileIcon}><Ionicons name="sparkles-outline" size={18} color={c.pink}/></View><Typography style={s.infoTileLabel}>Po co tu jestem</Typography><Typography numberOfLines={2} style={s.infoTileValue}>{account.goal}</Typography></View>}
          <View style={s.infoTile}><View style={s.infoTileIcon}><Ionicons name="heart-outline" size={18} color={c.pink}/></View><Typography style={s.infoTileLabel}>Zainteresowania</Typography><Typography numberOfLines={3} style={s.infoTileValue}>{(account.interests||[]).slice(0,4).join(' · ')||'Dodaj zainteresowania'}</Typography></View>
